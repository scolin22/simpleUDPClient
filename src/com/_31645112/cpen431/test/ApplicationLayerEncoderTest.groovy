package com._31645112.cpen431.test

import com._31645112.cpen431.A1.ApplicationLayerEncoder
...
class ApplicationLayerEncoderTest extends GroovyTestCase {
    void testGetHeader() {
        ...
        assert encoder.getHeader(timestamp, false) == b
    }
    ...
    void testGetPayload() {
        ...
        assert encoder.getPayload(1381632) == b

        b = [0x1, 0xE2, 0xDD, 0xB8]
        assert encoder.getPayload(31645112) == b
    }
    ...
    void testDecodeResponse() {
        ...
        assert encoder.decodeResponse(inBuf) == "D502F4661C49849B2B2FA95A623294BB"
    }
}
